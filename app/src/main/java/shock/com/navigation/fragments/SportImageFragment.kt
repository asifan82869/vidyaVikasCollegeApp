...
import kotlinx.android.synthetic.main.fragment_image_sport.*
...
class SportImageFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_image_sport, container, false)
    }
    ...
    private fun recycle(){
        ...
        val imageRef = mDataBaseRef.child("SportImage")
        ...
        val postListener = object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                if (mUpload.size != 0) {
                    ...
                    recyclerViewSport.adapter = adapter
                    recyclerViewSport.layoutManager = GridLayoutManager(nAct.contaxt, 2)
                    (recyclerViewSport.adapter as ImageAdapter).notifyDataSetChanged()
                }else{
