...
import kotlinx.android.synthetic.main.horizontal_image_show.*
import shock.com.navigation.R
import shock.com.navigation.data.Upload
import java.io.FileNotFoundException
import java.net.URL

class HorizontalImageAdapter(private val mContext: Context, var mUpload: ArrayList<Upload>, var listener: ClickListener) :
    RecyclerView.Adapter<HorizontalImageAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val inflater = LayoutInflater.from(mContext)
        val view = inflater.inflate(R.layout.horizontal_image_show, parent, false)
